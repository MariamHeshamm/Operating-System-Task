...
DECLARE_START_OF(ms_vs_qs_qsslave)
DECLARE_START_OF(ms_vs_qs_msslave)
DECLARE_START_OF(ms_vs_qs)
...
DECLARE_START_OF(tst_page_replacement_nthclock)
...
struct UserProgramInfo userPrograms[] = {
		...
		{ "tfifo", "Tests page replacement (FIFO algorithm 1)", PTR_START_OF(tst_page_replacement_FIFO_1)},
		{ "tclock", "Tests page replacement (clock algorithm)", PTR_START_OF(tst_page_replacement_clock)},
		{ "tnclock", "Tests page replacement (clock algorithm)", PTR_START_OF(tst_page_replacement_nthclock)},
		...
		{ "ms_vs_qs", "Mergesort vs Quicksort", PTR_START_OF(ms_vs_qs)},
		{ "qs_slave", "Quicksort v.1 - leakage", PTR_START_OF(ms_vs_qs_qsslave)},
		{ "ms_slave", "Mergesort v.1 - leakage", PTR_START_OF(ms_vs_qs_msslave)},
